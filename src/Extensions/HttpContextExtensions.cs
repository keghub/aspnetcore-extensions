...
namespace EMG.Extensions.AspNetCore
{
    public static class HttpContextExtensions
    {
        ...
        public static Task WriteModelAsync<TModel>(this HttpContext context, TModel model, HttpStatusCode statusCode = HttpStatusCode.OK)
        {
            ...
            return ExecuteResultAsync(context, result);
        }
    }
}